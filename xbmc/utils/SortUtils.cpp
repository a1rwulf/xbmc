...
odb::query<ODBView_TVShow> SortUtils::SortODBTVShowQuery(const SortDescription &sortDescription)
{
...
odb::query<ODBView_Episode> SortUtils::SortODBEpisodeQuery(const SortDescription &sortDescription)
{
...
odb::query<ODBView_Season> SortUtils::SortODBSeasonQuery(const SortDescription &sortDescription)
{
