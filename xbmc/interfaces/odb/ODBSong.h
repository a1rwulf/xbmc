...
PRAGMA_DB (view object(CODBSong) \
                ...
                query(distinct))
struct ODBView_Album_Artist_Song_Art
{
  std::shared_ptr<CODBArt> art;
  std::shared_ptr<CODBPersonLink> person_link;
};
...
PRAGMA_DB (view object(CODBSong) \
           ...
           object(CODBPerson: CODBPersonLink::m_person) \
           query(distinct))
struct ODBView_Album_File_Paths_Artists
{
  std::shared_ptr<CODBAlbum> album;
};
...
PRAGMA_DB (view object(CODBSong) \
           ...
           object(CODBPerson: CODBPersonLink::m_person) \
           query(distinct))
struct ODBView_Album_File_Artists_Count
{
...
PRAGMA_DB (view object(CODBSong) \
           ...
           object(CODBPerson inner: CODBPersonLink::m_person) \
           query(distinct) )
struct ODBView_Song_Artists_Count
{
  PRAGMA_DB (column("COUNT(" + CODBPerson::m_idPerson + ")"))
  std::size_t count;
};
