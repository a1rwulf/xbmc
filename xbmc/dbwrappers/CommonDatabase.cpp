...
{
  DatabaseSettings settings = &CServiceBroker::GetSettingsComponent()->GetAdvancedSettings()->m_databaseCommon ? CServiceBroker::GetSettingsComponent()->GetAdvancedSettings()->m_databaseCommon : DatabaseSettings();
